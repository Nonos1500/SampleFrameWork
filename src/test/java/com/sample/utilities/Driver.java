...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            String browserName = System.getProperty("browser") != null ? browserName = System.getProperty("browser") : com.sample.utilities.ConfigurationReader.getProperty("browser");
            ...
            switch(browserName){
                case "remote-chrome":
                    try {
                        ...
                        String gridAddress = ConfigurationReader.getProperty("remoteServer");
